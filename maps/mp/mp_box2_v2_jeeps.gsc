...
jeepy() 
{
	...
	thread spawn_jeep((1224, 3934, 72));
	thread spawn_jeep((3013, 4263, -30));
	thread spawn_jeep((-290, 1583, 8));
}
...
jeep thread onDestroyedJeep(spawnorigin);
