main()
{
	...
	maps\mp\_load::main();
	maps\mp\mp_zn_underground_mortar::main();
	maps\mp\mp_zn_underground_security::main();
	SpawnExtraTeleporters();
	maps\mp\mp_zn_underground_teleport::main();
...
SpawnExtraTeleporters()
{
	...
	teleporters[1]["origin"] = (-9230, -8464, 596);
...
Radio()
{
	...
	while(1)
	{
		radio playsound("zn_underground_radio");
		wait(200);
	}
}
...
StartPoint()
{
	...
	while(1)
	{
		...
		if(dmg > 30)
		{
			...
			self thread maps\mp\mp_zn_underground_mortar::playSoundAtLocation("explo_metal_rand", origin1, .1 );
			self thread maps\mp\mp_zn_underground_mortar::playSoundAtLocation("explo_metal_rand", origin2, .1 );
			self thread maps\mp\mp_zn_underground_mortar::playSoundAtLocation("explo_metal_rand", origin3, .1 );
			self thread maps\mp\mp_zn_underground_mortar::playSoundAtLocation("explo_metal_rand", origin4, .1 );
...
BlowUpTheWall()
{
	...
	self thread maps\mp\mp_zn_underground_mortar::playSoundAtLocation("building_explosion2", origin, .1 );
