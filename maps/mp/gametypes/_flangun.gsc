...
aa_spawn(origin)
{
	...
	trace = bulletTrace( origin, origin - (0,0,500), false, self );
...
customDestroy(aa)
{
	self iprintlnbold("Press ^4[^7Use^4]^7 To Destroy FlanGun");
